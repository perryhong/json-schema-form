...
export const CommonWidgetComponent = defineComponent({
  props: CommonWidgetPropsDefine,
})

export const SelectionWidgetComponent = defineComponent({
  props: SelectionWidgetPropsDefine,
})

export type CommonWidgetDefine = typeof CommonWidgetComponent

export type SelectionWidgetDefine = typeof SelectionWidgetComponent
